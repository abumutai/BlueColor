                    ...
                    <li class="nav-item dropdown has-arrow dropdown-heads ">
                        ...
                        <div class="dropdown-menu notifications">
                                    ...
                                    <li class="notification-message">
                                        <a href="provider-notifcations.html">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <p class="noti-details">Ray Arnold <span class="noti-title">left 6
                                                            comments on</span> Commercial Painting Services</p>
                                            ...
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    ...
                                                    <h6>“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                                        eiusmod tempor incididunt ut labore et commodo consequat..”</h6>
                                    ...
                                    <li class="notification-message">
                                        <a href="provider-notifcations.html">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <p class="noti-details">John Hammond <span class="noti-title">has
                                                            booked your</span> House Cleaning Services </p>
                            ...
                            <div class="topnav-dropdown-footer">
                                <a href="provider-notifcations.html">View More <img
                                        src="assets/img/icons/circle-icon.svg" alt=""></a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item  has-arrow dropdown-heads ">
