...
<!-- Mirrored from joblly-admin-template-dashboard.multipurposethemes.com/bs4/main-semidark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 09:46:29 GMT -->
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                ...
                <a href="index.html" class="logo">
                    ...
                    <div class="logo-lg">
                        <span class="light-logo"><img
                                src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/logo-light-text.png"
                                alt="logo"></span>
                        <span class="dark-logo"><img
                                src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/logo-dark-text.png"
                                alt="logo"></span>
                    </div>
                </a>
            </div>
            ...
            <section class="sidebar">
                <div class="user-profile px-20 pt-15 pb-10">
                    <div class="d-flex align-items-center">
                        <div class="image">
                            <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/avatar-13.png"
                    ...
                    <div class="media-list media-list-hover mt-20">
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-success" href="#">
                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/1.jpg"
                                    alt="...">
                            </a>
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-danger" href="#">
                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/2.jpg"
                                    alt="...">
                            </a>
                            <div class="media-body">
                                <p class="font-size-16">
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-warning" href="#">
                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/3.jpg"
                                    alt="...">
                            </a>
                            <div class="media-body">
                                <p class="font-size-16">
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-primary" href="#">
                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/4.jpg"
                                    alt="...">
                            </a>
                            <div class="media-body">
                                <p class="font-size-16">
    ...
    <div class="sticky-toolbar">
        <a href="#" data-toggle="tooltip" data-placement="left" title="Buy Now"
            class="waves-effect waves-light btn btn-success btn-flat mb-5 btn-sm" target="_blank">
            <span class="icon-Money"><span class="path1"></span><span class="path2"></span></span>
        </a>
        <a href="https://themeforest.net/user/multipurposethemes/portfolio" data-toggle="tooltip"
            data-placement="left" title="Portfolio"
    ...
    <script
        src="{{asset('feather-icons/feather.min.js')}}">
    </script>

    <script
        src="{{asset('apexcharts-bundle/dist/apexcharts.js')}}">
    </script>
    <script
        src="{{asset('moment/min/moment.min.js')}}">
    </script>
    <script
        src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/assets/vendor_components/fullcalendar/fullcalendar.js">
    </script>
...
<!-- Mirrored from joblly-admin-template-dashboard.multipurposethemes.com/bs4/main-semidark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Nov 2022 09:48:31 GMT -->
