...
<div class="content">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="work-img">
                    <img src="assets/img/work-01.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-4  order-last order-md-first">
                <div class="work-img">
                    <img src="assets/img/work-02.png" class="img-fluid" alt="">
                </div>
            </div>
            <div class="col-md-8">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="work-img mb-0">
                    <img src="assets/img/work-03.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
        <!-- /How it works -->
