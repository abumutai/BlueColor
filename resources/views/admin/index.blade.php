                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <div class="d-flex align-items-center mb-30">
                                            <div class="mr-15">
                                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/avatar-1.png"
                                        ...
                                        <div class="d-flex align-items-center mb-30">
                                            <div class="mr-15">
                                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/avatar-10.png"
                                                    class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                                            </div>
                                            <div class="d-flex flex-column flex-grow-1 font-weight-500">
                                        ...
                                        <div class="d-flex align-items-center mb-30">
                                            <div class="mr-15">
                                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/avatar-11.png"
                                                    class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                                            </div>
                                            <div class="d-flex flex-column flex-grow-1 font-weight-500">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="mr-15">
                                                <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/avatar-12.png"
                                                    class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                                            </div>
                                            <div class="d-flex flex-column flex-grow-1 font-weight-500">
                        ...
                        <div class="box box-inverse box-info">
                            <div class="box-body">
                                <a class="avatar float-left mr-20" href="javascript:void(0)">
                                    <img src="https://joblly-admin-template-dashboard.multipurposethemes.com/bs4/images/avatar/5.jpg"
                                        alt="">
                                </a>
                                <div>
